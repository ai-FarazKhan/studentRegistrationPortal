  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <br>
        ...
        <button type="button" class="btn btn-lg btn-light" disabled>Welcome Mr.<?php echo $_SESSION['userLoginName']?> To Edit FeedBack Section <i class="fas fa-eye" style="color:green;"></i></button>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Edit FeedBack Section.</h1>
</div>
<br>
<br>
<br>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    $getting_id_of_feedback = $_GET['id'];
    $query1 = "SELECT * FROM feedback WHERE id = '$getting_id_of_feedback'"; 
    $running_query1 = mysqli_query($setting_connection,$query1);

    if(isset($_POST['delete_btn']))
    {
        $query2 = "DELETE FROM feedback WHERE id = '$getting_id_of_feedback'";
...
<form action="" method="post">
  ...
  <div class="form-group">
    <label style="color:#f0ff00; font-size: 30px; display:inline;">Name: </label>
    <p style="color:orange; display:inline;"><?php echo $row['name'];?></p>
  </div>

  <div class="form-group">
    <label style="color:#f0ff00; font-size: 30px; display:inline;">Email: </label>
    <p style="color:orange; display:inline;"><?php echo $row['email'];?></p>
  </div>
  
  <div class="form-group">
    <label style="color:#f0ff00; font-size: 30px; display:inline;">Subject: </label>
    <p style="color:orange; display:inline;"><?php echo $row['subject'];?></p>
  </div>

  <div class="form-group">
    <label style="color:#f0ff00; font-size: 30px; display:inline;">Message: </label>
    <p style="color:orange; display:inline;"><?php echo $row['message'];?></p>
  </div>

<?php endwhile;?>


  <button type="submit" name="delete_btn" class="btn btn-danger btn-lg">Delete Feedback</button>

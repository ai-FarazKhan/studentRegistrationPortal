  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <br>
        ...
        <button type="button" class="btn btn-lg btn-light" disabled>Welcome Mr.<?php echo $_SESSION['userLoginName']?> To Timings Section <i class="fas fa-eye" style="color:green;"></i></button>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
          <a class="nav-link btn btn-outline-danger btn-lg" href="#add_timings_btn">Add Timings
          </a>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Timings Section.</h1>
</div>
<br>
<br>
<br>
  ...
  <?php
    ...
    $query = "SELECT * FROM test_timings";
...
?>
  ...
  <?php while($row = $running_query->fetch_array()):?>
    <tr>
      ...
      <td><a class="text-white" href="Edit_timings.php ?id=<?php echo $row['id'];?>"><?php echo $row['timings'];?></a></td>
    </tr>
    <?php endwhile;?>
  </tbody>
</table>
...
<form action="" method="POST">
    <button type="submit" name="delete_timings_btn" class="btn btn-outline-primary btn-lg btn-block">Delete All Timings</button>
</form>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    if(isset($_POST['delete_timings_btn']))
    {
        $query2 = "TRUNCATE TABLE test_timings"; 
        mysqli_query($setting_connection,$query2);
        header('location: Showing_Timings.php');
    }
    if(isset($_POST['add_btn']))
    {
        $taking_timings_input = $_POST['timings_txt'];

        if($taking_timings_input == '')
        {
            echo"<script>
            ...
            $query3 = "INSERT INTO test_timings (timings) VALUES('$taking_timings_input')";
            $running_add_timings_query = mysqli_query($setting_connection,$query3);
            header ('location: Showing_Timings.php');
        }
    }
?>
...
<div class="form-group">
  <label style="color:#f0ff00; font-size: 30px;">Add Timings</label>
    <input type="date" name="timings_txt" class="form-control">
    <br>
    <button type="submit" name="add_btn" class="btn btn-primary btn-lg" id="add_timings_btn">Add Timings</button>
  </div>
</form>
</div>
...
<div class="modal fade text-center" id="Insert_Something_notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <h1 class="display-4" style="color:orange;">Please Insert Timings !!</h1>
      </div>

  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <br>
        ...
        <button type="button" class="btn btn-lg btn-light" disabled>Welcome Mr.<?php echo $_SESSION['userLoginName']?> To Programs Section <i class="fas fa-eye" style="color:green;"></i></button>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Programs Section.</h1>
</div>
<br>
<br>
<br>
  ...
  <?php
    ...
    $query = "SELECT * FROM available_programs";
...
?>
  ...
  <?php while($row = $running_query->fetch_array()):?>
    <tr>
      ...
      <td><a class="text-white" href="Edit_Available_Programs.php ?id=<?php echo $row['id'];?>"><?php echo $row['program'];?></a></td>
    </tr>
    <?php endwhile;?>
  </tbody>
</table>
...
<form action="" method="POST">
    <button type="submit" name="submit" class="btn btn-outline-primary btn-lg btn-block">Delete All Available Programs</button>
</form>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    {
        $query2 = "TRUNCATE TABLE available_programs"; 
        mysqli_query($setting_connection,$query2);
        header('location: Showing_Available_Programs.php');
    }
    if(isset($_POST['add_btn']))
    {
        $taking_program_name_input = $_POST['program_name'];

        if($taking_program_name_input == '')
        {
            echo"<script>
            ...
            $query3 = "INSERT INTO available_programs (program) VALUES('$taking_program_name_input')";
            $running_add_program_query = mysqli_query($setting_connection,$query3);
            header ('location: Showing_Available_Programs.php');
        }
    }
?>
...
<div class="form-group">
  <label style="color:#f0ff00; font-size: 30px;">Add Program</label>
    <input type="text" name="program_name" class="form-control" placeholder="Enter Program name">
    <br>
    <button type="submit" name="add_btn" class="btn btn-primary btn-lg" id="add_program_section_btn">Add Program</button>
  </div>
</form>
</div>
...
<div class="modal fade text-center" id="Insert_Something_notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <h1 class="display-4" style="color:orange;">Please Insert Program Name !!</h1>
      </div>

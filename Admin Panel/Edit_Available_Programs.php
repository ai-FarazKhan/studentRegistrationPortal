  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <br>
        ...
        <button type="button" class="btn btn-lg btn-light" disabled>Welcome Mr.<?php echo $_SESSION['userLoginName']?> To Edit Programs Section <i class="fas fa-eye" style="color:green;"></i></button>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Edit Programs Section.</h1>
</div>
<br>
<br>
<br>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    $getting_id_of_available_Program = $_GET['id'];
    $query1 = "SELECT * FROM available_programs WHERE id = '$getting_id_of_available_Program'"; 
    $running_query1 = mysqli_query($setting_connection,$query1);

    if(isset($_POST['delete_btn']))
    {
        $query2 = "DELETE FROM available_programs WHERE id = '$getting_id_of_available_Program'";
    ...
    {
        $taking_input_program_Name =$_POST['program_name_txt'];

        if($taking_input_program_Name == ''){echo"insert something";}

        else{
            $query3 = "UPDATE available_programs SET program = '$taking_input_program_Name' WHERE id = ('$getting_id_of_available_Program')";
...
<form action="" method="post">
  ...
  <label style="color:#f0ff00; font-size: 30px; display:inline;">Program: </label>
    <input type="text" name="program_name_txt" class="form-control" value="<?php echo $row['program']?>">
  </div>

<?php endwhile;?>


  <button type="submit" name="update_btn" class="btn btn-primary btn-lg">Update Program</button>
  <button type="submit" name="delete_btn" class="btn btn-danger btn-lg">Delete Program</button>
